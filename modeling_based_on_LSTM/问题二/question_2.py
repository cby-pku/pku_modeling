...
data_train_file="C:\\Users\\Siqi Yang\\Desktop\\新建文件夹\\data1_trainset.txt"
data_test_file="C:\\Users\\Siqi Yang\\Desktop\\新建文件夹\\data1_testset.txt"
data_RUL_file="C:\\Users\\Siqi Yang\\Desktop\\新建文件夹\\data1_psi.txt"
...
test_data_file="C:\\Users\\Siqi Yang\\Desktop\\新建文件夹\\data1_testset.txt"
true_rul_file="C:\\Users\\Siqi Yang\\Desktop\\新建文件夹\\data1_psi.txt"
train_target_file="C:\\Users\\Siqi Yang\\Desktop\\新建文件夹\\train_psi.txt"
...
plt.figure()
plt.plot(deltap,color = "cornflowerblue")
plt.xlabel("Timestep")
plt.ylabel("deltap/1e6")
plt.title('deltap-Timestep')
#plt.scatter(64,deltap[64],color="red")
#plt.scatter(95,deltap[95],color="red")
plt.show()

plt.figure()
plt.plot(ratio,color = "cornflowerblue")
plt.xlabel("Timestep")
plt.ylabel("deltaP/(deltaQ*1e6)")
plt.title('deltap/deltaq-Timestep')
#plt.scatter(64,ratio[64],color="red")
#plt.scatter(92,ratio[92],color="red")
plt.axhline(y = maxratio, color="red",label="upper_bound = %f"%(maxratio))
plt.axhline(y = -maxratio, color="red",label="lower_bound = %f"%(maxratio)) #是一个参数 可以调整
plt.legend()
plt.show()

index = [j for j in range(len(ratio)) if abs(ratio[j]) >= maxratio]
print(index)

plt.subplot(1,2,1)
plt.plot(deltaq, color = "cornflowerblue")
plt.legend()
plt.xlabel("timeStep")
plt.ylabel("delta-Q")
plt.title('deltaQ-Time')
...
plt.xlabel("timeStep")
plt.ylabel("delta-P")
plt.title('deltaP-Time')
plt.show()


plt.subplot(1,2,1)
plt.plot(test_q, label = "Q", color = "cornflowerblue")
plt.legend()
plt.xlabel("timeStep")
plt.ylabel("Q")
plt.title('Q-Time')
...
plt.subplot(1,2,2)
plt.plot(test_p, label = "P", color = "cornflowerblue")
plt.legend()
plt.xlabel("timeStep")
plt.ylabel("P")
plt.title('P-Time')
...
plt.title('SPP-Time')
plt.show()
delta_psi = preds_for_last_example - true_psi
distance = 0.25*1e6
indices = [i for i in range(len(delta_psi)) if abs(delta_psi[i]) > distance]
print(indices)
index = [j for j in range(len(ratio)) if abs(ratio[j]) >= maxratio]
print(index)
plt.figure()
plt.plot(delta_psi, label = "delta SPP(psi)", color = "cornflowerblue")
plt.xlabel("timeStep")
plt.ylabel("delta SPP(psi)")
plt.title('delta SPP-Time')
for k in index:
    plt.scatter(k, delta_psi[k],color="red",label="ALARM")
plt.legend()
max_spp = max(preds_for_last_example - true_psi)
print(max_spp)
